...
const Header = () => {
  ...
  const renderMobileMenu = (
    ...
    >
      <button
        className="bg-pink-400 hover:bg-pink-500  text-white font-medium px-2 py-1 m-2 rounded-md flex"
        onClick={() => navigate("/add-contact")}
      >
        ADD CONTACT
      </button>
      <button className="bg-gray-100 text-black  px-3 py-1 m-2 rounded-md flex">
        <BsFilter />
      </button>

      <button className="bg-blue-700 text-white font-semibold px-3 py-1 m-2 rounded-md flex">
        <AiOutlineSearch />
      </button>
      {!loggedIn.email && (
        <button
          className="bg-gray-400 hover:bg-gray-500 text-white font-medium px-2 py-1 m-2  rounded-md flex"
